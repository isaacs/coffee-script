...
(function() {
  var Lexer, SourceMap, child_process, compile, fork, formatSourcePosition, fs, helpers, lexer, loadFile, parser, patchStackTrace, patched, path, vm,
  ...
  exports.run = function(code, options) {
    ...
    if (!helpers.isCoffee(mainModule.filename)) {
